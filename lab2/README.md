# Лабораторная работа №2: Обесцвечивание и бинаризация (вариант 13 - Адаптивное монохромное преобразование с усреднением по минимаксу, окно 3x3)
...
2. Приведение полутонового изображения к монохромному:
    - Метод: адаптивная пороговая обработка с усреднением по минимаксу в окне `3x3`.
    - Для каждого пикселя в окне `3x3` находятся `local_min` и `local_max`.
...
### 2. Приведение полутонового изображения к монохромному (адаптивный порог по минимаксу, окно 3x3)
